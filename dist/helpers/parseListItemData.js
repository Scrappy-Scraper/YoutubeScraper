...
function parseVideoChannelData(data) {
    ...
    let parseChannelIdFromUrl = function (url) {
    ...
    if (channelId === null)
        channelId = parseChannelIdFromUrl(findInObject(ownerText, "url") ?? "");
    if (channelId === null)
    ...
    if (channelId === null)
        channelId = parseChannelIdFromUrl(findInObject(shortBylineText, "url") ?? "");
    if (channelId === null)
    ...
    if (channelId === null)
        channelId = parseChannelIdFromUrl(findInObject(channelThumbnailData, "canonicalBaseUrl") ?? "");
    if (channelId === null)
        channelId = findInObject(channelThumbnailData, "browseId");
